...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Example Ltd, 1 Example st.
...
- **Website** refers to Example, accessible from [https://example.com](https://example.com)
...
- By visiting this page on our website: [http://example.com/privacy](http://example.com/privacy)
